...
namespace FlowersApp.Cart.Shared.Behaviours;
    ...
    where TRequest : IRequest<TResponse>
{
        ...
        RequestHandlerDelegate<TResponse> next, CancellationToken cancellationToken)
    {
        ...
        if (failures.Any())
        {
            ...
            throw new FlowersApp.Cart.Shared.Exceptions.ValidationException(failures); // ← JUST THROW, don't try to create response
        }
